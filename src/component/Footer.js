    ...
    return (
        <>
            <div className='w-full bg-white py-16'>
                <div className='md:max-w-[1320px] mx-auto grid md:grid-cols-5 max-w-[768px]:grid-col-2 gap-8 max-w-[600px]  md:px-0 px-4'>
                    <div className='col-span-2'>
                        <img src={logo} alt=' ' />
                        <h3 className='text-2xl py-3 font-bold'>Contact Us</h3>
                        <h3 className='py-2 text-[#60737A]'>Call : +123 400 123</h3>
