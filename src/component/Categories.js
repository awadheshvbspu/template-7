...
export default function Categories() {
  return (
    <>
        <div className='w-full bg-[#d3ebe2] py-20 '>
        <div className='md:max-w-[1320px] max-w-[600px] m-auto md:px-0 px-4'>
    ...
    <p className='text-lg text-gray-600'>Various versions have evolved over the years, sometimes by accident.</p>
        <div className='grid lg:grid-cols-4 md:grid-cols-2 py-12 md:gap-4 gap-2'>
